...
class GameState:
    ...
    def getGhostState(self, agentIndex):
        if agentIndex == 0 or agentIndex >= self.getNumAgents():
            raise ValueError("Invalid index passed to getGhostState")
        return self.data.agentStates[agentIndex]

    def getGhostPosition(self, agentIndex):
        if agentIndex == 0:
            raise ValueError("Pacman's index passed to getGhostPosition")
    ...
    def isFinished(self):
        return self.data._lose or self.data._win
