...
_string_hash = lambda s: adler32(s.encode('utf-8')) & 0xffffffff
...
class GameStateData:
    ...
    def _ghostStr(self, direction):
        return 'G'
        # TODO eeeee? nice method
...
class Game:
    ...
    def run(self,print_ghost_moves=False):
        # TODO add steps counter and max steps limit
        """
        ...
        for i in range(len(self.agents)):
            ...
            if not agent:
                ...
                # the other team wins
                print("Agent {} failed to load".format(i), file=sys.stderr)
                self.unmute()
        ...
        while not self.gameOver:
            ...
            # Track progress
            if agent_index == num_agents + 1: self.numMoves += 1
            # Next agent
